...
type CoinbaseTransaction struct {
	...
	// Salvium-specific fields (v3+)
	TxType          TransactionType       `json:"tx_type,omitempty"`
	AmountBurnt     uint64                `json:"amount_burnt,omitempty"`
	ReturnAddress   crypto.PublicKeyBytes `json:"return_address,omitempty"`
	SourceAssetType string                `json:"source_asset_type,omitempty"`
	DestAssetType   string                `json:"dest_asset_type,omitempty"`
